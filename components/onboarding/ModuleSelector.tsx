        ...
        {moduleOrder.map((key) => {
          ...
          return (
            <button
              ...
              aria-label={`${t(`${key}.name`)}: ${isEnabled ? tCommon('status.enabled') : tCommon('status.disabled')}`}
              className={`relative flex items-start gap-4 p-4 rounded-xl border-2 transition-all duration-200 text-left focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 ${
                isEnabled
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1">
                  <span className="text-xl" aria-hidden="true">{taskModule.icon}</span>
