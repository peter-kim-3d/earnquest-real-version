-- Update request_ticket_use to start screen time immediately (no parent approval needed)
-- Screen rewards now go directly to 'in_use' status and start the timer
...
BEGIN
  ...
  -- Only screen rewards can use this function
...
COMMENT ON FUNCTION request_ticket_use IS 'Child starts screen time immediately (no parent approval needed)';
